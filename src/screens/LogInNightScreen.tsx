/**
 * REELYOU Nighttime Sign In Screen v1.0 — DESIGN LOCKED
 *
...
import {
  ...
  logInNightWebViewportStyle,
  SignUpNightBrandHeader,
} from '@/components/auth';
import { AuthCopy } from '@/constants/auth';
import {
  LogInNightLayout,
  resolveLogInNightLogoWidth,
  resolveLogInNightTopInset,
...
export function LogInNightScreen() {
  ...
  const night = LogInNightLayout;
  const nightLogoWidth = resolveLogInNightLogoWidth(viewportWidth, viewportHeight);
...
function useScreenStyles() {
  ...
  return useThemedStyles((tokens) =>
    StyleSheet.create({
      ...
      forgotPassword: {
        alignSelf: 'flex-end',
        marginTop: night.forgotPasswordTopGap,
        paddingVertical: 4,
      },
      forgotPasswordText: {
        fontFamily: Fonts.sans,
