...
import { OnboardingChallengeIcon } from '@/components/onboarding/OnboardingChallengeIcon';
...
interface OnboardingChallengeChipProps {
  option: OnboardingChallengeOption;
  selected: boolean;
  disabled: boolean;
  onPress: () => void;
  style?: ViewStyle;
...
function OnboardingChallengeChipComponent({
  option,
  selected,
  disabled,
  onPress,
  style,
}: OnboardingChallengeChipProps) {
  ...
  return (
    <AnimatedPressable
      ...
      <OnboardingChallengeIcon name={option.icon} />
...
export const OnboardingChallengeChip = memo(OnboardingChallengeChipComponent);
