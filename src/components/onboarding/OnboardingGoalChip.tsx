...
import { OnboardingGoalIcon } from '@/components/onboarding/OnboardingGoalIcon';
...
interface OnboardingGoalChipProps {
  option: OnboardingGoalOption;
  selected: boolean;
  disabled: boolean;
  onPress: () => void;
  style?: ViewStyle;
...
function OnboardingGoalChipComponent({
  option,
  selected,
  disabled,
  onPress,
  style,
}: OnboardingGoalChipProps) {
  ...
  return (
    <AnimatedPressable
      ...
      <OnboardingGoalIcon name={option.icon} />
...
export const OnboardingGoalChip = memo(OnboardingGoalChipComponent);
