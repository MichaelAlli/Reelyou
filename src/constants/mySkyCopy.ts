...
export const MySkyCopy = {
  ...
  searchEmpty: 'No Skies found yet.',
  searchClose: 'Close',
  searchGroupConnected: 'Connected',
  searchGroupSharedCommunities: 'Shared Communities',
  searchGroupExplore: 'Explore',
  searchSharedCommunity: 'Shared community',
  searchSharedIn: 'Shared in {community}',
  ...
  proximityEntered: '{name}\u2019s Sky',
  proximityReturning: 'Your Sky',
  ownerSkyLabel: '{name}\u2019s Sky',
  ...
  privacyTitle: 'Sky Visibility',
  privacySubtitle: 'Choose what others can see when they visit your Sky.',
  privacyControlLabel: 'Privacy',
  privacySkyVisibility: 'Sky Visibility',
  privacySkyVisibilityHint: 'Who can discover and open your Public Sky.',
  privacyDefaultVisibility: 'Default Visibility',
  privacyDefaultVisibilityHint: 'New stars and unset content start here.',
  privacyOverridesTitle: 'Content Overrides',
  privacyOverridesHint: 'Optional limits for specific layers.',
